    ...
    function Hero({ height = "h-[40vh] md:h-[50vh]" }: HeroProps) {
      return (
        <section className={`relative overflow-hidden ${height} bg-gradient-to-b from-[#0a2540] via-[#163e63] to-[#1e3a5c]`}>
    ...
    export default async function PostPage(props: {
      ...
      return (
        <div className="bg-white min-h-screen">
          ...
          {/* Post Content - Pure white background */}
